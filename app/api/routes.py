...
from app.api.controllers.evaluation_controller import evaluate, evaluate_recommender
from app.api.controllers.knowledge_controller import sync_knowledge
from app.core.schemas import EvaluationMetrics, RecommenderEvaluationMetrics, RefactorResult, SmellDetection
...
routerAPI.add_api_route(
    ...
    methods=["POST"],
    response_model=RecommenderEvaluationMetrics,
    tags=["evaluation"],
)
