...
**Accuracy (totalmente correto):** 0.600 sobre 10 problemas

| Métrica | Valor |
|---|---|
| Pattern correto | 1.000 |
| Sintaxe válida | 1.000 |
| API pública preservada | 0.600 |
| Aprovado pelo Critic | 0.700 |
| Iterações médias | 1.30 |
...
**False Accept (aprovou incorreta):** 0 (FAR=0.000)  •  **False Reject (reprovou correta):** 1 (FRR=0.111)
...
| solutions/correct/sol_03_god_class.py | ERRO (resposta não-estruturada) | — |
...
| solutions/correct/sol_08_god_class.py | FN (false reject) | - |
